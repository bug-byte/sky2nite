...
import { StarOutline as StarOutlineIcon, VisibilityOutlined as VisibilityOutlinedIcon } from '@mui/icons-material';
        ...
        <Stack spacing={1.5}>
          <Box>
            <Typography variant="body2" color="text.secondary" sx={{ display: 'flex', alignItems: 'center', gap: 0.75 }}>
              ...
              <span>
                {t('LABEL.MAGNITUDE')}: <strong>{object.magnitude.toFixed(2)}</strong>
              </span>
            </Typography>
          </Box>
          ...
          <Box>
            ...
            <Typography variant="body2">
              RA: {formatCoordinate(object.ra)}° | Dec: {formatCoordinate(object.dec)}°
            </Typography>
          </Box>
          ...
          <Box>
            ...
            <Typography variant="body2">
              {formatTime(object.visibilityWindow.start)} - {formatTime(object.visibilityWindow.end)}
            </Typography>
            <Typography variant="caption" color="text.secondary">
              {t('MESSAGE.HOURS_ALTITUDE', { hours: object.visibilityWindow.duration.toFixed(1), altitude: object.maxAltitude })}
            </Typography>
          </Box>
            ...
            <Box>
              ...
              <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 0.5 }}>
                ...
                {object.tags.length > 5 && (
                  <Chip
                    label={t('MESSAGE.MORE_TAGS', { count: object.tags.length - 5 })}
                    size="small"
                    variant="outlined"
                  />
                )}
