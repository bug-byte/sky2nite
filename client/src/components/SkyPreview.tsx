    ...
    >
      ...
      {failed && (
        <Box sx={{ width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <Typography variant="caption" sx={{ color: 'rgba(255,255,255,0.3)', fontSize: '0.6rem', textAlign: 'center', px: 0.5 }}>
            No preview
          </Typography>
        </Box>
      )}
      ...
      {!failed && (
        ...
        >
          <line x1="50" y1="32" x2="50" y2="44" stroke="white" strokeWidth="1" strokeOpacity="0.85" />
          <line x1="50" y1="56" x2="50" y2="68" stroke="white" strokeWidth="1" strokeOpacity="0.85" />
          <line x1="32" y1="50" x2="44" y2="50" stroke="white" strokeWidth="1" strokeOpacity="0.85" />
          <line x1="56" y1="50" x2="68" y2="50" stroke="white" strokeWidth="1" strokeOpacity="0.85" />
        </Box>
      )}
    </Box>
  );
